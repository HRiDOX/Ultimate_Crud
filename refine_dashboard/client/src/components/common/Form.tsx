    ...
    <Box>
      ...
      <Box mt={2.5} borderRadius="15px" padding="20px" bgcolor="#fcfcfc">
        ...
        onSubmit={handleSubmit(onFinishHandler)}>
          <FormControl>
            <FormHelperText sx={{fontWeight:500,margin:'10px 0',fontSize:16 ,color:'#11142d'}}>Enter The Property Name</FormHelperText>
          ...
          <FormControl>
            ...
            <TextareaAutosize minRows={5} required placeholder="Write Description" color="info" style={{width:'100%',
            background:'transparent',fontSize:'16px',borderColor:'rgba(0,0,0,0.23)',
          ...
          <Stack direction="row" gap={4}>
            ...
            <TextField fullWidth required id="outlined-basic" color="info" type="number" variant="outlined" 
          ...
          <Stack direction="column" gap={1} justifyContent="center" mb={2}>
            <Stack direction="row" gap={2}>
              ...
              <Button component="label" sx={{width:'fit-content',color:"#2ed480",textTransform:'capitalize',fontSize:16}}>
                 ...
                 <input 
                  hidden
                  accept="image/*"//everything image type will accept
                  type="file"
                  onChange={(e) => {
                    //@ts-ignore
